...
import com.chaimchaikin.jewishdatetasker.bundle.PluginConditionBundleManager;
...
public final class QueryReceiver extends BroadcastReceiver
{
    ...
    public void onReceive(final Context context, final Intent intent)
    {
        ...
        if (PluginConditionBundleManager.isBundleValid(bundle))
        {
            final boolean isScreenOn =
                    (((PowerManager) context.getSystemService(Context.POWER_SERVICE)).isScreenOn());
            final boolean conditionState = bundle.getBoolean(PluginConditionBundleManager.BUNDLE_EXTRA_BOOLEAN_STATE);
